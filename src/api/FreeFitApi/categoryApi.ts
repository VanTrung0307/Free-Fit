...
import { Category } from 'models/freefit/category';
...
const categoryApi = {
  ...
  getAllPaging(params: PaginationRequest): Promise<Response<Category>> {
  ...
  getExcerciseById(id: string): Promise<Category> {
