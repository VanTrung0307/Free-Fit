...
import { Package } from 'models/freefit/package';
...
const exerciseApi = {
  ...
  getAllPaging(params: PaginationRequest): Promise<Response<Package>> {
    const url = '/package/paging';
  ...
  getExcerciseById(id: string): Promise<Package> {
